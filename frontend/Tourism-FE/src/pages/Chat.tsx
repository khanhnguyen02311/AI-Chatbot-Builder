...
function ChatPage() {
    ...
    return (
        <Box sx={{ height: "100vh", display: 'flex', flexDirection: 'row', alignItems: 'stretch' }}>
            <Box sx={{ bgcolor: "#212329", width: '300px', py: 4, px: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
                <Box sx={{ width: '100%', height: '100px', flex: 'none', display: 'flex', alignItems: 'center', justifyContent: 'stretch' }}>
                    <Box sx={{ pl: 4, flexGrow: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'start', justifyContent: 'center' }}>
                ...
                <Divider sx={{ width: '100%' }} />
                <Box sx={{ p: 4, width: '100%', maxHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <TextField maxRows={8}
                        id="input-area"
